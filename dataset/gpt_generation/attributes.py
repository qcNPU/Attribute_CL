...
instructions = [
"I will give you two question-anwser examples,please follow them and give the anwser of question 3,just output the anwser pieces split by | and every piece need be less than 12 words.Do not output any Unicode words and anything else except anwser pieces.\
...
def get_All_Descriptions(args):
    if args is None:
        gpt_dir = '/home/qc/Original_AttriCLIP/dataset/gpt_data'
        db_name = 'cifar100'
    else:
